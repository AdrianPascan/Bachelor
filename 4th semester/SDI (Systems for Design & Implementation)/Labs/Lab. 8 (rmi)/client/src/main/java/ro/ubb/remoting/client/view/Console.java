package ro.ubb.remoting.client.view;
...
import ro.ubb.remoting.common.domain.validators.BookStoreException;
...
//            }
    ...
    private void getTopBoughtBooks() {
        ...
        transactionService.getMostBoughtBooks(n).forEach((key, value) -> {
