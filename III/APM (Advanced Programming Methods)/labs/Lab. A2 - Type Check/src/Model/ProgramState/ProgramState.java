...
public class ProgramState {
    ...
    public ProgramState(InterfaceStatement program){
        ...
        statementId = ProgramState.getStatementId();
    }

    public ProgramState(InterfaceStatement program, ExecutionStack executionStack, SymbolTable symbolTable, Output outputList, FileTable fileTable, Heap heap, TypeEnvironment typeEnvironment) {
    ...
    public String toString() {
        return "PROGRAM STATE " +
                ...
                "\n" +  executionStack.toString() + symbolTable.toString() + outputList.toString() + fileTable.toString() + heap.toString();
    }
