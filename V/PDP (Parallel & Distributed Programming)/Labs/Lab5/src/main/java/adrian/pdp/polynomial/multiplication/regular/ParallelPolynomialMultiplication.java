...
public class ParallelPolynomialMultiplication {
    ...
    private static Polynomial multiplyDivideAndConquer(Polynomial first, Polynomial second) throws InterruptedException {
        ...
        MultiplyThread thread2 = new MultiplyThread(firstUpperHalf, secondLowerHalf);
        MultiplyThread thread3 = new MultiplyThread(firstLowerHalf, secondUpperHalf);
        MultiplyThread thread4 = new MultiplyThread(firstLowerHalf, secondLowerHalf);
        ...
        Polynomial term2 = PolynomialAddition.add(thread2.getPolynomial(), thread3.getPolynomial())
                .increaseOrder((first.getOrder() + 1) / 2);

        Polynomial term3 = thread4.getPolynomial();
